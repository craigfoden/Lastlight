class_name BuildMenu3D
extends CanvasLayer
## Bottom hotbar for the 3D game: one slot per buildable type showing hotkey,
## name, and cost. Purely a view over BuildController3D/TeamMaterials —
...
var _build_controller: BuildController3D
...
func setup(
		...
		build_controller: BuildController3D,
